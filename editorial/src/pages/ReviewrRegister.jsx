...
function ReviewrRegister() {
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:3000/auth/reviewrReg',
                {
                    email: email,
                    nom: nom,
                    password: password
    ...
    return (
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
          <h2 className="text-2xl font-bold mb-6 text-center">Reviewer Registration</h2>
          <form onSubmit={handleRegister}>
            <div className="grid grid-cols-1 gap-4 mb-4">
              ...
              <div>
                <label htmlFor="reviewExperience" className="block font-semibold mb-1">Reviewing Experience :</label>
                <textarea
                  className="border rounded-md px-3 py-2 w-full"
                  placeholder="Describe your reviewing experience"
...
export default ReviewrRegister