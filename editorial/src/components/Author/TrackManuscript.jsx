...
function Nodata() {
  return (
    <div className="p-4  text-center ">
      <p className="mb-6">Vous n'avez soumis aucun manuscrit.</p>
      <a
              ...
              >
                ...
                <td
                 ...
                 className="text-sm text-gray-900 font-normal px-6 py-4 whitespace-nowrap">
                                    <button onClick={()=>{navigateTo(`${item._id}`)}} className="bg-blue-200 hover:bg-cyan-200 p-2 rounded-md">See All details </button>
                </td>
                <td className="text-sm text-gray-900 font-normal px-6 py-4 whitespace-nowrap">
