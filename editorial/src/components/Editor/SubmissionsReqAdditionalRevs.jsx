...
function SubmissionsReqAdditionalRevs() {
    ...
    useEffect(()=>{
     ...
     { try {
        const response = await axios.get(`http://localhost:3000/editor/getEditors/${manuscriptId}`)
...
export default SubmissionsReqAdditionalRevs ;
